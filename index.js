...
// Generate TTML subtitles with proper RTL support for Arabic
function generateTTML(verses, preferences) {
  ...
  const fontSize = preferences.fontSize === 'large' ? '150%' : 
  ...
  <head>
    ...
    <styling>
      <style xml:id="arabicStyle" 
             tts:fontFamily="Arial Unicode MS, Scheherazade, serif" 
...
// Create MediaConvert job parameters with TTML and style passthrough
